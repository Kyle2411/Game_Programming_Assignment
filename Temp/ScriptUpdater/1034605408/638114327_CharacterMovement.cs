...
// Is Grounded
animator.SetBool("IsGrounded", GetComponent<Rigidbody>().velocity.y == 0);

// Update animator rotation
Quaternion newRotation = Quaternion.LookRotation(GetComponent<Rigidbody>().velocity.normalized);
